...
func InitOptionMap() {
	...
	common.OptionMap["QueueEnabled"] = strconv.FormatBool(setting.QueueEnabled)
	common.OptionMap["QueueDefaultTimeout"] = strconv.Itoa(setting.QueueDefaultTimeout)
	common.OptionMap["QueueMaxTimeout"] = strconv.Itoa(setting.QueueMaxTimeout)
	common.OptionMap["QueueGlobalMaxSize"] = strconv.Itoa(setting.QueueGlobalMaxSize)
	...
	common.OptionMap["ApplicationHeaderDetectionMode"] = "off"
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" {
		...
		case "QueueEnabled":
			setting.QueueEnabled = boolValue
	...
	case "QueueDefaultTimeout":
		setting.QueueDefaultTimeout, _ = strconv.Atoi(value)
	case "QueueMaxTimeout":
		setting.QueueMaxTimeout, _ = strconv.Atoi(value)
	case "QueueGlobalMaxSize":
		setting.QueueGlobalMaxSize, _ = strconv.Atoi(value)
	case "RetryTimes":
